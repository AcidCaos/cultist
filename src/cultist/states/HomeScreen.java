...
public class HomeScreen extends Screen {
    ...
    public void render(Graphics g) {
        ...
        Font.render(g, "Cultist", centerX, centerY - 16, true);
        Font.render(g, "Press any key", centerX, centerY + 8, true);
        Font.render(g, "to start", centerX, centerY + 16, true);
        Font.render(g, "(c) AcidCaos 2021", centerX, handler.getHeight() - 8, true);
    }
}
